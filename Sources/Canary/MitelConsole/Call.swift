...
typealias CallDecoder = RegularExpressionDecoder<MitelConsole.Call>
typealias CallPattern = RegularExpressionPattern<MitelConsole.Call, MitelConsole.Call.CodingKeys>
...
extension MitelConsole.Call {
    ...
    /// - Returns: A new `Date`.
    func initiatedAt(year: MitelConsole.Year) -> Date? {
...
extension CallDecoder {
    ...
    func decode(from line: String, phoneBook: MitelConsole.PhoneBook) throws -> MitelConsole.Call {
        var call = try self.decode(MitelConsole.Call.self, from: line)
